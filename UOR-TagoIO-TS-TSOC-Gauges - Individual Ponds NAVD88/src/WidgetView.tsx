        ...
        Object.entries(variablesByGroup).forEach(([groupKey, variables]) => {
          ...
          if (variables.name && 
            ...
            const waterLevelRecord: EntityWaterLevelData = {
              id: groupKey,
              name: variables.name,
              currentLevel: Number(variables.navd_current_we),
              minOperational: variables.navd_min_op_we !== undefined && variables.navd_min_op_we !== null ? Number(variables.navd_min_op_we) : undefined,
              maxOperational: variables.navd_max_op_we !== undefined && variables.navd_max_op_we !== null ? Number(variables.navd_max_op_we) : undefined,
              normalLevel: Number(variables.navd_normal_we) || 0,
              normalDeviation: variables.navd_normal_we_deviation || 0,
              topOfPond: variables.navd_alarm_top !== undefined && variables.navd_alarm_top !== null ? Number(variables.navd_alarm_top) : undefined,
